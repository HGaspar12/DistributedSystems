...
public class TelaCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuOperacoes.setBackground(new java.awt.Color(255, 0, 0));
        menuOperacoes.setText("Operações");
        menuOperacoes.setToolTipText("");
        menuOperacoes.setBorderPainted(true);
        menuOperacoes.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
    ...
    /*
    private void transferirMouseClicked(java.awt.event.MouseEvent evt) {                                      
        this.dispose();
